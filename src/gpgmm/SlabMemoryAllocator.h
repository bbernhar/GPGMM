...
namespace gpgmm {
    ...
    class SlabMemoryAllocator : public MemoryAllocator {
      ...
      private:
        ...
        // and a reference to the underlying memory. A RefCounted is used to determine if the slab
        // is empty where |SlabMemory| can be safely released.
    ...
    // SlabCacheAllocator enables the use of unknown-size allocation by caching one or more
    // SlabMemoryAllocators in multiples of |minBlockSize|.
