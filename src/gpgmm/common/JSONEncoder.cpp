...
namespace gpgmm {
    ...
    void JSONDict::AddItem(const std::string& name, char value) {
        return AddString(name, "\"" + std::string(1, value) + "\"");
    }

    void JSONDict::AddItem(const std::string& name, const char* value) {
        return AddString(name, "\"" + std::string(value) + "\"");
    }
    ...
    void JSONArray::AddItem(std::string value) {
        return AddString("\"" + value + "\"");
    }

    void JSONArray::AddItem(uint64_t value) {
        return AddString(std::to_string(value));
    }
    ...
    void JSONArray::AddItem(const JSONDict& object) {
        return AddString(object.ToString());
    }
