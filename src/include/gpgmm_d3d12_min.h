...
// gpgmm_d3d12_min is self-contained minimum viable GPGMM implementation.
//
// This is a lightweight GPGMM implementation that specifically allows users to leverage GPGMM's
// portable GMM interface without requiring the full GPGMM implementation in the build, allowing for
// incremental enabling during development.
//
// Internally, GPU memory will not be re-used nor does it do any residency management (will no-op).
// It is functionality-equivelent to calling ID3D12Device::CreateCommittedResource.

// This macro must be defined should these platform headers be already provided.
